...
namespace JobSolution.Infrastructure.Seed
{
    public  class Seeder
    {
        ...
        public static async Task CreateRoles(RoleManager<Role> roleManager, AppDbContext dbContext)
        {
        ...
        public static async Task Populate(AppDbContext dbContext, RoleManager<Role> roleManager, UserManager<User> userManager)
        {
            await CreateRoles(roleManager, dbContext);
